...
const Header = () => {
  ...
  return (
    <section className="text-gray-600 body-font mb-5" style={{ height: '300px', position: 'relative' }}>
        ...
        <div className="flex flex-row items-center justify-between" style={{ height: '100%' }}>
          ...
          >
            <textarea
              ...
              className="p-2 rounded focus:outline-none address-input"
              style={{ width: '100%', height: '100%', resize: 'both', overflow: 'auto', border: address ? 'none' : '1px solid gray' }}
            />
          </Rnd>
        </div>
      </div>
